    ...
    <section className="py-24 px-[5%] bg-white">
      <ScrollReveal className="text-center mb-[52px]">
        ...
        <h2 className="font-heading text-[clamp(2rem,3.5vw,3rem)] font-normal text-navy leading-[1.2] -tracking-wide mt-3.5">
          Trusted by <em className="italic text-gold">Our Clients</em>
          <br />
          Across New Jersey
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-[22px] mt-[50px]">
        {TESTIMONIALS.map((t, i) => (
          <ScrollReveal key={t.name} delay={i * 0.1}>
            <div
              className={`h-full rounded-xl p-[34px] relative transition-all hover:-translate-y-1 flex flex-col ${
                t.featured
            ...
            >
              ...
              <p
                className={`text-[0.91rem] leading-7 italic mb-[22px] flex-1 ${
