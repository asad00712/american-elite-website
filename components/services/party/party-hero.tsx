  ...
  return (
    <section className="relative py-24 md:py-32 overflow-hidden">
      <div
        ...
        style={{
          backgroundImage:
            "url('https://images.unsplash.com/photo-1519671482749-fd09be7ccebf?w=1800&q=80')",
        }}
      >
      ...
      <div className="relative z-10 text-center px-[5%]">
        <ScrollReveal>
          ...
          <p className="text-[1.05rem] text-white/55 mt-4 max-w-[600px] mx-auto leading-7">
            Make your special occasions unforgettable with our luxury party
            limos, SUVs, and party buses
          </p>
          <Link
            href="/contact"
