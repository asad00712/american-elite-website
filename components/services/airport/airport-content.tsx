    ...
    <div className="space-y-14">
      ...
      <ScrollReveal>
        ...
        <p className="text-[0.95rem] text-body-2 leading-7">
          ...
          obtain by using our Limousine Services.
        </p>
      </ScrollReveal>
      ...
      <ScrollReveal>
        ...
        <p className="text-[0.95rem] text-body-2 leading-7">
          ...
          Limousine to take care of you with our top notch Limousine
          Service. You can usually make a reservation the day before you need
          our service, but if you need a quick ride, you can check
      ...
      <ScrollReveal>
        ...
        <p className="text-[0.95rem] text-body-2 leading-7">
          If you need our limousine transportation service in the
